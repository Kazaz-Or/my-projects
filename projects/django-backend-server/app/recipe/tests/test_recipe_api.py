...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        other_user = create_user(email='other@example.com', password='test123pass')
    ...
    def test_filter_by_tags(self):
        r1 = create_recipe(user=self.user, title='Thai Vegi Curry')
        r2 = create_recipe(user=self.user, title='Italian Pasta')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Dairy')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Grill')
