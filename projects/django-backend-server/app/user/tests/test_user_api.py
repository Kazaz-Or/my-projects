...
class PublicUserApiTests(TestCase):
    """Tests for API requests that doesn't require authentication"""
    ...
    def test_create_token_for_user(self):
        user_details = {'email': 'test@example.com', 'password': 'testpass123', 'name': 'Tester Name'}
...
class PrivateUserApiTests(TestCase):
    """Tests for API requests that requires authentication"""

    def setUp(self):
        self.user = create_user(email='test@example.com', password='testpass123', name='Tester Name')
        self.client = APIClient()
